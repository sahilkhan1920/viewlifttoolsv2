...
import usePaymentsPlatforms from 'src/hooks/usePaymentsPlatforms'
...
const SubscriptionPayments = () => {
  ...
  const {
    page: { tabs, chartType = 'line' },
  } = useHeaders()

  const { data, loading, selectedMetrics, metrics } = usePayments({
